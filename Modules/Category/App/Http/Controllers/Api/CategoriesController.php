...
class CategoriesController extends \Lynx\Base\Api
{
    protected $entity = Category::class;
    protected $resourcesJson = \Modules\Category\App\resources\CategoriesResource::class;
    protected $policy = \Modules\Category\App\Policies\CategoriesPolicy::class;
    protected $guard = 'api';
    ...
    {
        return new \Modules\Category\App\resources\CategoriesResource($entity);
    }
