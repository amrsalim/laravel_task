...
class AdminGroupsController extends \Lynx\Base\Api
{
    protected $entity = \Modules\AdminGroup\App\Models\AdminGroups::class;
    protected $resourcesJson = \Modules\AdminGroup\App\resources\AdminGroupsResource::class;
    protected $policy = \Modules\AdminGroup\App\Policies\AdminGroupsPolicy::class;
    protected $guard = 'api';
    ...
    {
        return new \Modules\AdminGroup\App\resources\AdminGroupsResource($entity);
    }
