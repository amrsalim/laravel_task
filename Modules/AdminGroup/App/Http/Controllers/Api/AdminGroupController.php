...
use Modules\AdminGroup\App\Policies\AdminGroupPolicy;
use Modules\AdminGroup\App\resources\AdminGroupResource;

class AdminGroupController extends \Lynx\Base\Api
{
    protected $entity = AdminGroup::class;
    protected $resourcesJson = AdminGroupResource::class;
    protected $policy = AdminGroupPolicy::class;
    protected $guard = 'api';
    ...
    {
        return new \Modules\AdminGroup\App\resources\AdminGroupResource($entity);
    }
