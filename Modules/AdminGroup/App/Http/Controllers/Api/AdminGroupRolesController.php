<?php 
namespace Modules\AdminGroup\App\Http\Controllers\Api;

class AdminGroupRolesController extends \Lynx\Base\Api
{
    protected $entity = \Modules\AdminGroup\App\Models\AdminGroupRoles::class;
    protected $resourcesJson = \Modules\AdminGroup\App\resources\AdminGroupRolesResource::class;
    protected $policy = \Modules\AdminGroup\App\Policies\AdminGroupRolesPolicy::class;
    protected $guard = 'api';
    ...
    {
        return new \Modules\AdminGroup\App\resources\AdminGroupRolesResource($entity);
    }
